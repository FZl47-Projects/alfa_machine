...
!function (NioApp, $) {
    ...
    //         data: [200, 0, 20, 44, 60, 60, 60, 60, 60, 60, 95, 138, 126, 110, 90, 170, 250, 290, 280, 270, 260, 245, 225, 205, 230, 264, 280, 300, 370, 440, 420, 460]
    //     }, {
    //         label: "تبلیغات گوگل",
    //         color: "#FD9722",
    //         dash: [0, 0],
            ...
            options: {
                plugins: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function label(context) {
                                return "".concat(context.parsed.y, " ").concat('تسک');
                            }
                        },
                        backgroundColor: '#fff',
                        borderColor: '#eff6ff',
